...
internal class SerializableSpanDataTest {
    ...
    private fun compareSpanContexts(expected: SpanContext, observed: io.opentelemetry.kotlin.framework.serialization.SerializableSpanContext) {
    ...
    private fun compareStatusData(expected: StatusData, observed: io.opentelemetry.kotlin.framework.serialization.SerializableSpanStatusData) {
    ...
    private fun compareEvents(expected: List<EventData>, observed: List<io.opentelemetry.kotlin.framework.serialization.SerializableEventData>) {
    ...
    private fun compareLinks(expected: List<LinkData>, observed: List<io.opentelemetry.kotlin.framework.serialization.SerializableLinkData>) {
        assertEquals(expected.size, observed.size)
    ...
    private fun compareResource(expected: Resource, observed: io.opentelemetry.kotlin.framework.serialization.SerializableResource) {
