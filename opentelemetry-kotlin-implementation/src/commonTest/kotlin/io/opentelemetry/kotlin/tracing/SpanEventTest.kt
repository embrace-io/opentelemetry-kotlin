...
internal class SpanEventTest {
    ...
    fun setUp() {
        ...
        spanLimitConfig = SpanLimitConfig(
            ...
            linkCountLimit = _root_ide_package_.io.opentelemetry.kotlin.tracing.fakeSpanLimitsConfig.linkCountLimit,
    ...
    fun testSpanEventAttributesLimit() {
        ...
        assertEquals(_root_ide_package_.io.opentelemetry.kotlin.tracing.fakeSpanLimitsConfig.attributeCountLimit, event.attributes.size)
    }
