...
internal class ReadableSpanConversionTest {
    ...
    private fun assertResource(
        ...
        observed: io.opentelemetry.kotlin.framework.serialization.SerializableSpanData
    ) {
    ...
    private fun assertSpanContext(
        lhs: SpanContext,
        rhs: io.opentelemetry.kotlin.framework.serialization.SerializableSpanContext
    ) {
