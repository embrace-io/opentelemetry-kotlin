...
internal class SpanExtTest {
    ...
    fun testRecordException() {
        val span = _root_ide_package_.io.opentelemetry.kotlin.tracing.FakeSpan()
    ...
    fun testAddLinkSimple() {
        val a = _root_ide_package_.io.opentelemetry.kotlin.tracing.FakeSpan()
        val b = _root_ide_package_.io.opentelemetry.kotlin.tracing.FakeSpan()
