...
internal class BatchTelemetryProcessorTest {
    ...
    fun testInvalidMaxQueueSize() {
        assertFailsWith<IllegalArgumentException> {
            _root_ide_package_.io.opentelemetry.kotlin.export.BatchTelemetryProcessor<Unit>(
                maxQueueSize = -1,
                scheduleDelayMs = 1,
                exportTimeoutMs = 1,
    ...
    fun testNoExportAfterShutdown() = runTest {
        ...
        val processor = _root_ide_package_.io.opentelemetry.kotlin.export.BatchTelemetryProcessor(
            maxQueueSize = 100,
            maxExportBatchSize = 1,
            scheduleDelayMs = 1,
